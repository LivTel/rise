...
*/
// ARCImplementation.java -*- mode: Fundamental;-*-
// $Header: /space/home/eng/cjm/cvs/rise/ccs/java/ARCImplementation.java,v 1.1 2009-10-15 10:21:18 cjm Exp $
...
public class ARCImplementation extends CALIBRATEImplementation implements JMSCommandImplementation
{
	 ...
	 */
	public final static String RCSID = new String("$Id: ARCImplementation.java,v 1.1 2009-10-15 10:21:18 cjm Exp $");
	...
	/**
	 * This method gets the ARC command's acknowledge time. The ARC command is not implmented
	...
	/**
	 * This method implements the ARC command. The CCS does not implement the ARC command so
	...
	public COMMAND_DONE processCommand(COMMAND command)
	{
		...
		arcDone.setErrorNum(CcsConstants.CCS_ERROR_CODE_NO_ERROR);
...
// Revision 0.6  2006/05/16 14:25:37  cjm
